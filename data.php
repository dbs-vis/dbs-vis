						...
						<table>
							<thead>
								<tr>
									<td></td>
									<?php
									foreach ($yearList as $curYear) {echo '<th id="'.$curYear.'" scope="col">'.$curYear.'</th>';}
									?>
								</tr>
							</thead>
							<tbody>
									...
									if (isset($lib_name)) {
										...
										foreach ($yearList as $curYear) {
											if (isset ($libraryData[$curYear][0])) {
												echo '<td headers="'.$curYear.'">'.number_format($libraryData[$curYear][0], $precision[$key], ',', '.').'</td>';
											} else {
												echo '<td headers="'.$curYear.'">-</td>';
											}
										}
									}
									?>
								...
								<tr>
									...
									foreach ($yearList as $curYear) {
										if (isset ($whiskersData[$curYear][1])) {
											echo '<td headers="'.$curYear.'">'.number_format($whiskersData[$curYear][1], $precision[$key], ',', '.').'</td>';
										} else {
											echo '<td headers="'.$curYear.'">-</td>';
										}
									}
								...
								<tr>
									...
									foreach ($yearList as $curYear) {
										if (isset ($boxesData[$curYear][2])) {
											echo '<td headers="'.$curYear.'">'.number_format($boxesData[$curYear][2], $precision[$key], ',', '.').'</td>';
										} else {
											echo '<td headers="'.$curYear.'">-</td>';
										}
									}
								...
								<tr>
									...
									foreach ($yearList as $curYear) {
										if (isset ($boxesData[$curYear][1])) {
											echo '<td headers="'.$curYear.'">'.number_format($boxesData[$curYear][1], $precision[$key], ',', '.').'</td>';
										} else {
											echo '<td headers="'.$curYear.'">-</td>';
										}
									}
								...
								<tr>
									...
									foreach ($yearList as $curYear) {
										if (isset ($boxesData[$curYear][0])) {
											echo '<td headers="'.$curYear.'">'.number_format($boxesData[$curYear][0], $precision[$key], ',', '.').'</td>';
										} else {
											echo '<td headers="'.$curYear.'">-</td>';
										}
									}
								...
								<tr>
									...
									foreach ($yearList as $curYear) {
										if (isset ($whiskersData[$curYear][0])) {
											echo '<td headers="'.$curYear.'">'.number_format($whiskersData[$curYear][0], $precision[$key], ',', '.').'</td>';
										} else {
											echo '<td headers="'.$curYear.'">-</td>';
										}
									}
